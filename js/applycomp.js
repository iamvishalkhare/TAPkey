...
{
	document.getElementById(compid).innerHTML = '<img src="http://localhost/dashboard/tapkey/img/apply.gif">';
	//document.getElementById(compid).innerHTML = '<img src="http://scanitjsr.org/tapkey/tapkey/img/apply.gif">';
...
function processCheckDB2(compid)
{
	...
	{	
		var url = "http://localhost/dashboard/tapkey/php/applycomp.php?compid="+compid;  //Sending Data to php script for validation
		//var url = "http://www.scanitjsr.org/tapkey/php/applycomp.php?compid="+compid;  //Sending Data to php script for validation
